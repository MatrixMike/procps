...
pkgdatadir = $(datadir)/procps-ng
pkgincludedir = $(includedir)/procps-ng
pkglibdir = $(libdir)/procps-ng
pkglibexecdir = $(libexecdir)/procps-ng
...
am__append_2 = pidof
am__append_3 = pidof.1
#am__append_4 = pidof.1
am__append_5 = kill
am__append_6 = kill.1
#am__append_7 = kill.1
#am__append_8 = \
...
snice_LDADD = $(LDADD)
snice_DEPENDENCIES = ./proc/libprocps.la $(am__DEPENDENCIES_2)
am_sysctl_OBJECTS = sysctl.$(OBJEXT) lib/fileutils.$(OBJEXT)
sysctl_OBJECTS = $(am_sysctl_OBJECTS)
sysctl_LDADD = $(LDADD)
sysctl_DEPENDENCIES = ./proc/libprocps.la $(am__DEPENDENCIES_2)
...
##am__objects_1 =  \
##	lib/strverscmp.$(OBJEXT)
#am_top_top_OBJECTS = top/top.$(OBJEXT) \
#	top/top_nls.$(OBJEXT) \
#	lib/fileutils.$(OBJEXT) $(am__objects_1)
top_top_OBJECTS = $(am_top_top_OBJECTS)
#top_top_DEPENDENCIES = $(am__DEPENDENCIES_3) \
#	$(am__DEPENDENCIES_1)
am_uptime_OBJECTS = uptime.$(OBJEXT) lib/fileutils.$(OBJEXT)
uptime_OBJECTS = $(am_uptime_OBJECTS)
uptime_LDADD = $(LDADD)
uptime_DEPENDENCIES = ./proc/libprocps.la $(am__DEPENDENCIES_2)
am_vmstat_OBJECTS = vmstat.$(OBJEXT) lib/strutils.$(OBJEXT) \
	lib/fileutils.$(OBJEXT)
vmstat_OBJECTS = $(am_vmstat_OBJECTS)
vmstat_LDADD = $(LDADD)
vmstat_DEPENDENCIES = ./proc/libprocps.la $(am__DEPENDENCIES_2)
...
SOURCES = $(proc_libprocps_la_SOURCES) $(free_SOURCES) $(kill_SOURCES) \
	...
	$(lib_test_process_SOURCES) $(lib_test_strtod_nol_SOURCES) \
	$(lib_test_strutils_SOURCES) $(pgrep_SOURCES) $(pidof_SOURCES) \
	$(pkill_SOURCES) $(pmap_SOURCES) $(ps_pscommand_SOURCES) \
	$(pwdx_SOURCES) $(skill_SOURCES) $(slabtop_SOURCES) \
	$(snice_SOURCES) $(sysctl_SOURCES) $(tload_SOURCES) \
	$(top_top_SOURCES) $(uptime_SOURCES) $(vmstat_SOURCES) \
	$(w_SOURCES) $(watch_SOURCES)
DIST_SOURCES = $(proc_libprocps_la_SOURCES) $(free_SOURCES) \
	...
	$(lib_test_strtod_nol_SOURCES) $(lib_test_strutils_SOURCES) \
...
am__DIST_COMMON = $(dist_man_MANS) $(srcdir)/Makefile.in \
	...
	ltmain.sh missing mkinstalldirs test-driver
...
ACLOCAL = ${SHELL} /home/mikeh/procps-ng-3.3.12/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/mikeh/procps-ng-3.3.12/missing autoconf
AUTOHEADER = ${SHELL} /home/mikeh/procps-ng-3.3.12/missing autoheader
AUTOMAKE = ${SHELL} /home/mikeh/procps-ng-3.3.12/missing automake-1.15
AWK = mawk
CC = gcc -std=gnu99
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/mikeh/procps-ng-3.3.12/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = procps-ng 3.3.12
...
abs_builddir = /home/mikeh/procps-ng-3.3.12
abs_srcdir = /home/mikeh/procps-ng-3.3.12
abs_top_builddir = /home/mikeh/procps-ng-3.3.12
abs_top_srcdir = /home/mikeh/procps-ng-3.3.12
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/mikeh/procps-ng-3.3.12/install-sh
...
dist_man_MANS = free.1 pgrep.1 pkill.1 pmap.1 pwdx.1 sysctl.8 \
	...
	$(am__append_12) proc/openproc.3 proc/readproc.3 \
	proc/readproctab.3
EXTRA_DIST = .version autogen.sh contrib COPYING.LIB \
	...
	$(DIST_MAN_POTS) $(am__append_4) $(am__append_7) \
	$(am__append_13) proc/libprocps.sym
procpsngdir = $(docdir)
dist_procpsng_DATA = \
...
LIBprocps_AGE = 0
proc_libprocps_la_LIBADD = $(LIB_KPARTS) $(am__append_14)
...
lib/test_strtod_nol.$(OBJEXT): lib/$(am__dirstamp) \
	lib/$(DEPDIR)/$(am__dirstamp)

lib/test_strtod_nol$(EXEEXT): $(lib_test_strtod_nol_OBJECTS) $(lib_test_strtod_nol_DEPENDENCIES) $(EXTRA_lib_test_strtod_nol_DEPENDENCIES) lib/$(am__dirstamp)
	@rm -f lib/test_strtod_nol$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(lib_test_strtod_nol_OBJECTS) $(lib_test_strtod_nol_LDADD) $(LIBS)
...
pgrep$(EXEEXT): $(pgrep_OBJECTS) $(pgrep_DEPENDENCIES) $(EXTRA_pgrep_DEPENDENCIES) 
	@rm -f pgrep$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(pgrep_OBJECTS) $(pgrep_LDADD) $(LIBS)

pidof$(EXEEXT): $(pidof_OBJECTS) $(pidof_DEPENDENCIES) $(EXTRA_pidof_DEPENDENCIES) 
	@rm -f pidof$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(pidof_OBJECTS) $(pidof_LDADD) $(LIBS)

pkill$(EXEEXT): $(pkill_OBJECTS) $(pkill_DEPENDENCIES) $(EXTRA_pkill_DEPENDENCIES) 
	@rm -f pkill$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(pkill_OBJECTS) $(pkill_LDADD) $(LIBS)
...
pwdx$(EXEEXT): $(pwdx_OBJECTS) $(pwdx_DEPENDENCIES) $(EXTRA_pwdx_DEPENDENCIES) 
	@rm -f pwdx$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(pwdx_OBJECTS) $(pwdx_LDADD) $(LIBS)

skill$(EXEEXT): $(skill_OBJECTS) $(skill_DEPENDENCIES) $(EXTRA_skill_DEPENDENCIES) 
	@rm -f skill$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(skill_OBJECTS) $(skill_LDADD) $(LIBS)

slabtop$(EXEEXT): $(slabtop_OBJECTS) $(slabtop_DEPENDENCIES) $(EXTRA_slabtop_DEPENDENCIES) 
	@rm -f slabtop$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(slabtop_OBJECTS) $(slabtop_LDADD) $(LIBS)

snice$(EXEEXT): $(snice_OBJECTS) $(snice_DEPENDENCIES) $(EXTRA_snice_DEPENDENCIES) 
	@rm -f snice$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(snice_OBJECTS) $(snice_LDADD) $(LIBS)

sysctl$(EXEEXT): $(sysctl_OBJECTS) $(sysctl_DEPENDENCIES) $(EXTRA_sysctl_DEPENDENCIES) 
	@rm -f sysctl$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(sysctl_OBJECTS) $(sysctl_LDADD) $(LIBS)
...
vmstat$(EXEEXT): $(vmstat_OBJECTS) $(vmstat_DEPENDENCIES) $(EXTRA_vmstat_DEPENDENCIES) 
	@rm -f vmstat$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(vmstat_OBJECTS) $(vmstat_LDADD) $(LIBS)

w$(EXEEXT): $(w_OBJECTS) $(w_DEPENDENCIES) $(EXTRA_w_DEPENDENCIES) 
	@rm -f w$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(w_OBJECTS) $(w_LDADD) $(LIBS)

watch$(EXEEXT): $(watch_OBJECTS) $(watch_DEPENDENCIES) $(EXTRA_watch_DEPENDENCIES) 
	@rm -f watch$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(watch_OBJECTS) $(watch_LDADD) $(LIBS)
...
include ./$(DEPDIR)/pgrep.Po
include ./$(DEPDIR)/pidof.Po
include ./$(DEPDIR)/pmap.Po
include ./$(DEPDIR)/pwdx.Po
include ./$(DEPDIR)/skill.Po
include ./$(DEPDIR)/slabtop.Po
include ./$(DEPDIR)/sysctl.Po
include ./$(DEPDIR)/tload.Po
include ./$(DEPDIR)/uptime.Po
include ./$(DEPDIR)/vmstat.Po
include ./$(DEPDIR)/w.Po
include ./$(DEPDIR)/watch.Po
include lib/$(DEPDIR)/fileutils.Po
include lib/$(DEPDIR)/nsutils.Po
include lib/$(DEPDIR)/strutils.Po
include lib/$(DEPDIR)/strverscmp.Po
include lib/$(DEPDIR)/test_fileutils.Po
include lib/$(DEPDIR)/test_nsutils.Po
include lib/$(DEPDIR)/test_process.Po
include lib/$(DEPDIR)/test_strtod_nol.Po
include lib/$(DEPDIR)/test_strutils.Po
include proc/$(DEPDIR)/alloc.Plo
include proc/$(DEPDIR)/devname.Plo
include proc/$(DEPDIR)/escape.Plo
include proc/$(DEPDIR)/pwcache.Plo
include proc/$(DEPDIR)/readproc.Plo
include proc/$(DEPDIR)/sig.Plo
include proc/$(DEPDIR)/slab.Plo
include proc/$(DEPDIR)/sysinfo.Plo
include proc/$(DEPDIR)/version.Plo
include proc/$(DEPDIR)/wchan.Plo
include proc/$(DEPDIR)/whattime.Plo
include ps/$(DEPDIR)/display.Po
include ps/$(DEPDIR)/global.Po
include ps/$(DEPDIR)/help.Po
include ps/$(DEPDIR)/output.Po
include ps/$(DEPDIR)/parser.Po
include ps/$(DEPDIR)/select.Po
include ps/$(DEPDIR)/sortformat.Po
include ps/$(DEPDIR)/stacktrace.Po
include top/$(DEPDIR)/top.Po
include top/$(DEPDIR)/top_nls.Po
...
recheck: all $(check_PROGRAMS)
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
lib/test_strtod_nol.log: lib/test_strtod_nol$(EXEEXT)
	@p='lib/test_strtod_nol$(EXEEXT)'; \
	b='lib/test_strtod_nol'; \
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	uninstall-dist_procpsngDATA uninstall-libLTLIBRARIES \
	uninstall-man uninstall-man1 uninstall-man3 uninstall-man5 \
